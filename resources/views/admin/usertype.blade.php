                ...
                <div id="typography">
                    ...
                    <div class="row">
                        <div class="tim-typo">
                            ...
                            <div>
                                <form action="{{url('updateusertype',$user->id)}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="div_center">
                                        <label for="post-description">UserType</label>
                                        <textarea id="post-description" name="usertype" >{{$user->usertype}}</textarea>
                                    </div>
                                    <div class="div_center">
